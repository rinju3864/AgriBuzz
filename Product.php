...
if(isset($_POST['submit']))
{
	...
	{
		$qty = $_POST['quantity'];
		$sql ="UPDATE product SET category_id='$_POST[category]', produce_id='$_POST[produce]', variety_id='$_POST[variety]', title='$_POST[title]', ";
		if($_FILES['img1']['name'] != "")
		{
		...
		$sql = $sql . " quantity='$_POST[quantity]', quantity_type='$_POST[quantitytype]', description='$_POST[description]', uploaded_date='$dt', status='$status' WHERE product_id='$_GET[editid]'";
