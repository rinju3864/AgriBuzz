  ...
  <footer id="footer">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            <h3>AgriBuzz</h3>
            <p>
              AIIT, Amity University <br>
              Noida - 201301<br>
              Uttar Pradesh, India <br><br>
              <strong>Phone:</strong> +91-81972 93613<br>
              <strong>Email:</strong> rahul.jose@s.amity.edu<br>
            </p>
          </div>
    ...
    <div class="container d-md-flex py-4">
      ...
      <div class="mr-md-auto text-center text-md-left">
        <div class="copyright">
          &copy; Copyright <strong><span>AgriBuzz</span></strong>. All Rights Reserved
        </div>
        <div class="credits">
